<div class="header-top">
    <nav id="top-navigation">
        <ul>
            ...
            <li><a href="blog/category/news-and-updates/" class="<?= is_active('blog/category/news-and-updates') ?>" title="News">News  <?= ($catalog->check()) ? '<span class="badge">New</span>' : null ?>  <span class="badge navbar_badge_increase">New</span>  </a>
            </li>
                ...
                <div class="container">
                    <div class="naviagtions">
                        ...
                        <div class="main-menu heder-menu">
                            <ul>
                                <li><a href="index.php" class="<?= is_active(['index.php', 'index']) ?>" title="Home">Home</a></li>
                                <li class="position-relative"><a href="blog/category/news-and-updates/" class="<?= is_active('blog/category/news-and-updates') ?> " title="News">News<?= ( $catalog->check()) ? '<span class="badge">New</span>' : null ?>  <span class="badge">New</span> </a></li>
                                <li><a href="alumni/success-stories.php" class="<?= is_active('alumni/success-stories.php') ?>" title="Alumni">Alumni</a></li>
