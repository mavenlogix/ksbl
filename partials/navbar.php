<div class="header-top">
    <nav id="top-navigation">
        <ul>
            ...
            <li><a href="blog/category/news-and-updates/" class="<?= is_active('blog/category/news-and-updates') ?>" title="News"><?= (!is_active('blog/category/news-and-updates') && $catalog->check()) ? 'New ' : null ?>News</a></li>
