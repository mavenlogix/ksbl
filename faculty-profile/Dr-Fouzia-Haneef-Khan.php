    ...
    <div class="faculty-section teacher-group">
        ...
        <div class="container">
            ...
            <div class="faculty_grid">
                ...
                <div class="faculty_grid_left dr-fouzia">
                    ...
                    <div class="tab-content mt-2">
                        ...
                        <div id="vita" class=" tab-pane active">
                           ...
                           <p>At Imperial College London, she is mainly responsible for coordinating, teaching, and organizing the M.Sc. Genes, Drugs and Stem Cells – Novel Therapies Program of the Faculty of Medicine since 2019. As a lead for the Coordinated Transformation Group, she plays a key role in the transformation of the M.Sc. program to blend remote delivery. She is a project supervisor and a module leader for the Evidence, Information and Communication module and the Research project module in her program. She also teaches ad-hoc to the Bachelor of Medicine, Bachelore of Surgery (MBBS) students and is a personal and academic tutor for undergraduates and postgraduates within the Faculty.</p>
                            ...
                            <p>Dr. Khan completed her Ph.D. in Neuropharmacology from University College London (UCL), UK under the supervision of Professor Mike Simmonds. Her Ph.D. research investigated the "Influence of membrane cholesterol on Neurosteroid modulation of Benzodiazepine/ GABAA receptor." She also graduated with 1st class honors in BSc UCL, UK. During her undergraduate degree, she spent a year working in the Development Pharmacology department as a Research Associate within Glaxo Smith Kline. </p>
                        ...
                        <div id="credentials" class=" tab-pane fade"><br>
                            ...
                            <ul>
                               <li>
                                   2021-2022 <br>
                                   MEd (Masters in University Learning and Teaching), Imperial College London.
                                </li>
                                <li>
                                    2020-2021 <br>
                                    PGDip ULT (Postgraduate Diploma in University Learning and Teaching), Imperial College  London.
                                </li>
                                <li>
                                    2019-2020 <br>
                                ...
                                <li>
                                    2019-2020 <br>
                                    PGCert ULT (Postgraduate Certificate in University Learning and Teaching), Imperial  College London.
                                </li>
                                <li>
                                    1996-2000 <br>
                                    PhD in Neuropharmacology, UCL, UK.
                                </li>
                                <li>
                                    1992-1996 <br>
                                    BSc in Pharmacology and Toxicology – 1 st Class Honours Degree, UCL, UK.
                                </li>
                            </ul>

                            <p><b>Awards & Achievements</b></p>
                            <p>
                            ...
                            <p><b>PROFESSIONAL PRESENTATIONS</b></p>
                            <ul>
                        ...
                        <div id="publications" class=" tab-pane fade">
                            ...
                            <h4 class="text-primary mt-4">Research</h4>
