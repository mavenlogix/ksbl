    ...
    <div class="faculty-section teacher-group">
        <div class="container">
            <div class="faculty_grid">
                <div class="faculty_grid_left dr-ahmad-junaid">
                    <div class="faculty_grid_head">
                        <h1>Dr. Ahmad Junaid</h1>
                        <h4>Associate Professor<br> Finance & Accounting</h4>
                        <a href="mail:to">ahmad.junaid@ksbl.edu.pk</a>
                    </div>
                </div>
                    ...
                    <div class="tab-content mt-2">
                        ...
                        <div id="publications" class=" tab-pane fade"><br>
                            ...
                            <p><span class="text-primary">Conferences</span><br>
                                Papers accepted/presented in the following international conferences/workshops
                            </p>
                            <p>
                                <ul style="list-style: square;">
