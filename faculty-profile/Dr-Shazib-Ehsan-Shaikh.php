            ...
            <div class="faculty_grid">
                <div class="faculty_grid_left dr-shazid">
                    <div class="faculty_grid_head">
                        <h1>Dr. Shazib Shaikh</h1>
                        <h4>Associate Professor<br>Business Analytics<br>Head of Department, Decision Sciences</h4>
                ...
                <div class="faculty_grid_center">
                    ...
                    <div class="tab-content mt-2">
                        <div id="vita" class=" tab-pane active">
                            <p><span style="color: #ff9f19;">Dr. Shazib Shaikh </span>
                                is an Associate Professor of Decision Sciences at KSBL. Previously, during nine years of executive education experience at LUMS, he has directed and taught various executive courses, e.g. Data-Savvy Decision-Making (Coca Cola), ERP Systems, Retail Management, IT-based Change Management (Telenor and Tameer Microfinance joint venture: easypaisa), Executive Development (UFone), Agri-business Management (with Nestle participants). He has worked on consultancy projects for Telenor, Mantaq Systems (implementation partners for MS Dynamics for Pakistani retailers such as Stylo Shoes), Coca Cola BPL, Naseeb Networks and AdSells. More recently, he documented the roll-out and implementation of big data analytics in Punjab IT Board's dengue program and demonstrated dashboard analytics for more efficient geo-analytical disease prevention audits.
                            </p>
                            <p>Dr. Shazib delivered the first case-method based MBA business intelligence, spreadsheet modelling and digital marketing courses at LUMS. Similarly, he delivered the first business analytics and decision behavior courses for the LUMS undergraduate program in Management Sciences. At ITU, his HoD role made him the effective Acting Dean of the fledgling business school, seeing it through the transition to online teaching during the COVID-19 pandemic.</p>
                            <p>Dr. Shazib’s PhD in the UK was initially sponsored by B2BNet who acquired the rights to the technology he developed during his Masters for scalable and flexible web application architecture. He remained a software developer for them until his study got funded by a prestigious UK Overseas Research Scholarship.</p>
                        </div>
                        <div id="credentials" class=" tab-pane fade"><br>
                            <h4 class="text-primary">Education</h4>
                            <p>
                                <b>PhD Informatics, University of Manchester, UK</b><br>
                                Thesis: Cross-organizational workflow negotiation: requirements & an approach<br>
                                2006
                            </p>
                            <p>
                                <b>MSc Computation – Distinction, University of Manchester Institute of Science & Technology, UK</b><br>
                                Dissertation: Scalable & Flexible Architectures for SMEs<br>
                                2000
                            </p>
                            <p>
                                <b>BSc (Hons) Accounting & Financial Analysis, University of Warwick, Coventry, UK</b><br>
                                1999
                            </p>
                            <h4 class="text-primary">Awards & Achievements</h4>
                            <ul>
                                <li class="mt-3"><b>Ruth Greene Memorial Award for “easypaisa” (Best Int’l Case),</b> NACRA October 2011 <br>Conference, San Antonio, USA</li>
                                <li class="mt-3"><b>"Best Case in IT track" Award for Stylo Case,</b> SDSB-AJMC 2011, 1st Int’l Case <br>Conference, May 2011.</li>
                                <li class="mt-3"><b>Machine Learning A to Z: in R & Python (2018)</b> certification completed (41 hrs Udemy)</li>
                                <li class="mt-3"><b>14th European Emerald/CEEMAN</b> case award for ROZEE.PK in 2009</li>
                                <li class="mt-3">Won <b>Overseas Research Scholarship (UK)</b> award - funded PhD based on academic distinction</li>
                            </ul>
                        </div>
                        <div id="interests" class=" tab-pane fade"><br>
                            <p><b>Professional Experience</b></p>
                            <p>
                                <b>Information Technology University,</b> Faculty of Business & Management, Lahore, Pakistan<br>
                                Chair & Acting Dean – 2019- 2020<br>
                                Assistant Professor (BI, eBusiness) – 2017 – 2020
                            </p>
                            <p>
                                <b>Lahore University of Management Sciences (LUMS),</b> Suleman Dawood School of Business, Lahore<br>
                                <u>Assistant Professor (Decision Science, Business Intelligence)</u> – 2006-2017<br>
                                <u>Director of SDSB Case Research Centre</u> – 2010-2013
                            </p>
                            <p>
                                <span class="text-primary">University of Manchester Institute of Science & Technology (UMIST) <b>(Manchester, UK)</b></span>
                                <br>
                                Research and Teaching Assistantships – 2002-2003
                            </p>
                            <p><b>B2B Net (Pvt) Ltd</b> (Manchester, UK), Software Architect & Developer – 2000-2001</p>
                            <p><b>Consulting Experience </b></p>
                            <p>
                                <b>AdSells (Pvt) Limited</b> – 2019<br>
                                Analysis and recommendations on raw material wastage reduction and overtime management.
                            </p>
                            <p>
                                <b>Coca Cola Beverages Limited</b> - 2014<br>
                                Design of a program (LNA) to train 200 managers in sales target optimization, sensitivity analysis, seasonal forecasting, pivot charts, and XL-based decision modeling.
                            </p>
                            <p>
                                <b>Telenor Pakistan</b> - 2014<br>
                                Design of training (LNA) for the cross-functional Easypaisa team from both the telecoms & banking divisions (Tameer Microfinance) in mobile accounts expansion strategy and turbulent innovation-driven change management based on historical studies of easypaisa and the BI division.
                            </p>
                            <p>
                                <b>Mantaq Systems (now part of Confiz) / Stylo Shoes</b> - 2010<br>
                                Evaluation of the business level impacts of BI initiatives and selection and installation of MS Dynamics (vs. homegrown system vs. Retail Pro), integration with Oracle Financials and data maintenance challenges.
                            </p>
                            <p>
                                <b>Naseeb Networks / ROZEE.PK</b> - 2007<br>
                                Analysis of Broadband Internet Market (6000 responses to ROZEE.PK survey).
                            </p>
                        </div>
