...
?>
            <div class="header-content d-block">
                <a href="index.php" title="KSBL" class="logo d-block d-md-inline-block">
                    ...
                    <div class="accordion " id="faq">
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead2">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2"><span>2</span>Entrepreneurialism</a>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead3">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3"><span>3</span>Technology Savviness</a>
                            </div>
                         ...
                         <div class="card">
                            <div class="card-header" id="faqhead4">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq4" aria-expanded="true" aria-controls="faq4"><span>4</span>Global Mindedness</a>
                            </div>
                          ...
                          <div class="card">
                            <div class="card-header" id="faqhead5">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq5" aria-expanded="true" aria-controls="faq5"><span>5</span>Sustainability Focus</a>
                            </div>
