            ...
            <div class="open-house-content single-blog">
                ...
                <div class="center-page-content news-and-events container-boxes">
                    ...
                    <div class="blog-detail">
                        <p>
                        The trainer, Dr. Muhammad Athar Siddiqui (Associate Professor of Organizational Behavior and Human Resources KSBL) shared effective leadership skills required for developing cohesive teams. The program also covered the importance of strategic decision-making and its impact on the performance of individuals as well as teams.
                        </p>
                      
                        <p>
                       Professionals, managers, and project leaders from various industrial fields were part of this professional training. Simulations, self-assessments, exercises and case studies were utilized to practically impart leadership skills to the participants.
                        </p>
                    ...
                    <div class="other-pictures">
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_2.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_3.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_4.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_5.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_6.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_7.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/lead_high_8.jpg" alt="Data Science">
                            </div>
                        </div>
                          <div class="blog-image-section image">
                            <div class="campus-image">
