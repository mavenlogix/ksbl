            ...
            <div class="open-house-content single-blog">
                ...
                <div class="center-page-content news-and-events container-boxes">
                    <div class="blog-header">
                        <img src="images/blog/Nai_Subah_thumbnail.jpg" alt="Blog other">
                        <div class="blog-name">
                            <div class="tag">Events</div>
                            <h2>KSBL Hosted an Event Organized by "Nai Subah"</h2>
                            <div class="post-date">Saturday, December, 4th, 2021</div>
                        </div>
                    </div>
                    <div class="blog-detail">
                        <p>
                        KSBL, being part of Dawood Group, under its CSR wing has long work history on human development & community building. Based on this concept of Inclusion & Diversity, KSBL hosted an event organized by "Nai Subah" for the empowerment of visually impaired youth at KSBL campus on December 3, 2021, in honour of International Disability Day. People from all walks of life attended the event.
                        </p>
                    ...
                    <div class="other-pictures">
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img1.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img2.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img3.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img4.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img5.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img6.jpg" alt="Data Science">
                            </div>
                        </div>
                        <div class="blog-image-section image">
                            <div class="campus-image">
                                <img src="images/blog/Nai_Subah_img7.jpg" alt="Data Science">
                            </div>
                        </div>
