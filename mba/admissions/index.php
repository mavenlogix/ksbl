...
?>
            ...
            <div class="header-content">
                ...
                <div class="heder-info">
                    ...
                    <h2>Enrolling motivated learners through an established <br>evaluation process</h2>
                </div><!-- container -->
            </div>
        </div><!-- container -->
    ...
    <div class="departments add">
        <div class="container">
            <a href="mba/admissions/" class="department active" title="Admission Process">Admissions Process</a>
            <a href="mba/fee/" class="department" title="Fee">Fees</a>
            ...
            <div class="content-area">
                <div class="admission-process">
                    ...
                    <div class="tabs-content">
                        <!-- ==== eligibility === -->
                        <div class="tab-content active" data-tab="eligibility">
                            <div class="sec-row">
                                ...
                                <div class="sec-col">
                                    ...
                                    <ul>
                                      ...
                                      <li>This includes HSSC (min. 60% marks), A-Levels (Minimum one B and 2 Cs) or Equivalent & IB</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="sec-row">
