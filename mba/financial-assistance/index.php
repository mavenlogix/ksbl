        ...
        <div class="container  remove-padding-bottom">
            <div class="content-area">
                ...
                <div class="fee-table">
                    ...
                    <div class="table-row">
                        <div class="table-col">KSBL Interest Free Loans</div>
        ...
        <div class="container  remove-padding">
            <div class="content-area">
                <div class="admission-process">
                    <div class="tabs">
                        <div class="tab active" data-tab="Types_Financial_Assistance">Types of Financial Assistance</div>
                        <div class="tab" data-tab="Assessment_Process">Need Assessment Process</div>
                        <div class="tab" data-tab="Terms_and_Conditions">Terms and Conditions</div>
                        <div class="tab" data-tab="Document_Checklist">Need Assessment Document Checklist</div>
                    </div>
